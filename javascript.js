...
/************************ SELETORES JAVASCRIPT-***************** /
  document = acessar o documento html

  document.getElementById("selciona o elemento pelo id da tag no html") 
  
  document.querySelect("")Posso usar .classe, posso usar #id ( escrever como no css)
  
  documento.querySelectorAll("ul") ele retorna listas
...
/******************************* METODOS ***********************************
   const elementoCriado =  document.createElement("a") cria elementos html

    main.oppenChild(elementoCriado) insere o elemento criado na pagina

    main.remove(elementoCriado) apaga o elemento informado
...
/******************************** EVENTOS**************************************
 *TODA E QUALQUER INTERAÇÃO QUE O USUARIO TEM COM A PAGINA 

 lista de evento: https://www.marciobrasil.net.br/javascript-2/lista-completa-de-eventos-javascript.html

 elemento.addEventListener('evento,ação a ser executada); Exemplo abaixo

 const divExemplo = document.querySeletor('div1')

 div.Exemplo.addEventListener('click', imprimentoHelloword); // excutador de

 function imprimentoHelloword(){
     console.logo('Hello Word')
 }
